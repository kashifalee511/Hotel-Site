...
export default function Room() {
  ...
  return (
    <div>
     ...
     text-white bg-[url("./src/assets/rooms001.jpg")] opacity-55 bg-no-repeat bg-center  bg-cover h-[80vh]'>
      <h1 className='text-black'>Hotel Rooms</h1>
    ...
    <div className='px-10 w-2/3'>
      ...
      <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
        ...
        <div className='md:w-1/2 flex flex-col gap-2'>
          ...
          <h2 onClick={()=>navigate(`/rooms/${room._id}`)}
           className='text-white text-start'>{room.hotel.name}</h2>
